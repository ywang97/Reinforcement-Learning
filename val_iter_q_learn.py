...
# test_solve_play()
# Tabular Q-learn
# test_learn_play(iters=800000, tabular=True, batch=False)
# Tabular Batch Q-learn
# test_learn_play(iters=250, tabular=True, batch=True) # Check: why do we want fewer iterations here?
# NN Q-learn
# test_learn_play(iters=80000, tabular=False, batch=False)
# NN Batch Q-learn (Fitted Q-learn)
test_learn_play(iters=50, tabular=False, batch=True)
